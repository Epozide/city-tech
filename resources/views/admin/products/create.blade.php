	...
	<div class="card-body">
		...
		<form action="{{ isset($product) ? route('products.update', $product->slug) : route('products.store')}}" method="post" enctype="multipart/form-data">
			...
			<div class="row justify-content-between m-auto">
				...
				<!-- product price -->
				<div class="form-group">
					<label for="dprice">Product Price (Before Discount)</label>
					<input type="decimal" name="dprice" id="dprice" class="form-control @error('dprice') is-invalid @enderror" value="{{ isset($product) ? $product->dprice : old('dprice') }}">
				...
				<div class="form-group">
					...
					<input type="decimal" name="saved" id="saved" class="form-control @error('saved') is-invalid @enderror" value="{{ isset($product) ? $product->dprice-$product-> price: old('dprice-price') }}" readonly>
			...
			<div class="row ml-2">
				...
				<!-- product final price -->
				<div class="form-group">
					<label for="price">Product Final Price</label>
