...
<div class="card col-lg col-xl-9 flex-row mx-auto px-0">
    ...
    <div class="card-body">
        <h4 class="title text-center mt-2 mb-3">تسجيل الدخول</h4>
        <form class="form-box px-3"method="POST" action="{{ route('login') }}">
            ...
            <div class="form-input">
                ...
                <input type="password" name="password" placeholder="كلمة السر" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
            ...
            <div class="mb-3">
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="remember">تذكر المعلومات</label>
              </div>
            </div>
            ...
            <div class="text-right">
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="forget-link">نسيت كلمة السر</a>
                @endif
            </div>
