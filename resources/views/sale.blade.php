...
<title>City Tech: Products On Sale</title>
<meta charset="UTF-8">
	...
	<div class="page-top-info">
		<div class="container">
			...
			<div class="site-pagination">
				...
				<a href="https://citytechluxor.com/on-sale">العروض</a> /
			</div>
		</div>
	</div>
	<!-- Page info end -->
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									...
									<b><a href='{{ route('single-product', $p->slug) }}' style="color:#9999ff;">{{$p->price}} EGP</a><br></b>
