		...
		<div class="container">
			<div class="row">
					...
					<div class="cart-table">
						...
						<div class="cart-table-warp">
							<table>
								<thead>
									<tr>
										<th class="size-col">رقم الطلب</th>
										<th class="size-col">الحساب</th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td class="total-col"><h4>{{ $order->billing_total }} EGP</h4></td>
										<td>
											<a href="{{ route('my-profile.show', $order->id) }}" class="btn btn-success btn-sm">اظهار الطلب</a>
										</td>
									</tr>
									@endforeach
								</tbody>
				...
				<div class="col-lg-4 card-right">
					<a href="{{ route('my-profile.edit') }}" class="site-btn">اعداداتي</a>
					<a href="{{ route('frontendCategories') }}" class="site-btn sb-dark">المنتجات</a>
				</div>
			</div>
		</div>
	</section>
