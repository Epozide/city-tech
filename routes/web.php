...
Route::get('login/{provider}', 'Auth\LoginController@redirectToProvider')->middleware('verified');
Route::get('login/{provider}/callback', 'Auth\LoginController@handleProviderCallback')->middleware('verified');
