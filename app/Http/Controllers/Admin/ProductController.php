...
class ProductController extends Controller
{
    ...
    public function store(CreateProductRequest $request)
    {
        ...
        $product = Product::create([
			...
			'saved' => $request->dprice-$request->price,
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $data = $request->only(['name', 'code', 'description', 'price', 'dprice','saved','category_id', 'sub_category_id', 'quantity', 'meta_description', 'meta_keywords', 'is_new', 'on_sale']);
